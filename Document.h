...
private:
    ...
    // Create an AVL tree with the variable title as what the key indicates and the value as the IIUD
//    std::unordered_map<std::string, DSAVLTree<std::string>> texts;
//    std::unordered_map<std::string, DSAVLTree<std::string>> persons;
//    std::unordered_map<std::string, DSAVLTree<std::string>> organizations;
